...
// Run from the repository root: dotnet run --file backend/scripts/generate-kubernetes.cs
...
internal static class KubernetesGeneratorApp
{
    internal static int Run(string[] args)
    {
        ...
        {
            Console.Error.WriteLine("Usage: dotnet run --file backend/scripts/generate-kubernetes.cs -- [--check] [--self-test]");
            return 2;
        }
